HOBBES_VERSION := $(shell cat HOBBES_VERSION)
HOBBES_DEPS := $(wildcard HOBBES_*)
DOCKER_TAG_PREFIX := rzuckerm/hobbes:$(HOBBES_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(HOBBES_DEPS)
